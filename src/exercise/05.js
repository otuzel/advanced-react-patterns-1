...
function App() {
  // Additional functionality added by client
  const [timesClicked, setTimesClicked] = React.useState(0)
  const clickedTooMuch = timesClicked >= 4

  // Custom reducer to support the additional functionality added by client
  ...
  // Client improves the functionality by passing his custom reducer to useToggle hook
